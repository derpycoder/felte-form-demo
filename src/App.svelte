...
<div class="flex flex-col items-center w-full py-10">
	...
	<main
		...
		<form
			...
			<div
				class="grid grid-flow-row grid-cols-2 grid-rows-1 gap-x-4 gap-y-6">
				<div>
					<label
						for="title"
			...
			<div
				class="grid grid-flow-row grid-cols-3 grid-rows-2 gap-x-4 gap-y-6">
